import { JSBI, Token } from '@valueswap/sdk'
...
export default function MigrateV1() {
  ...
  const V1LiquidityTokens: Token[] = useMemo(() => {
    return chainId
      ? Object.keys(V1Exchanges).map(exchangeAddress => new Token(chainId, exchangeAddress, 18, 'VNTW-V1', 'Valueswap V1'))
      : []
  }, [chainId, V1Exchanges])
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from Valueswap V1 and deposit it into Valueswap
          V2.
        </TYPE.body>
