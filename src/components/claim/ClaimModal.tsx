import { JSBI, TokenAmount } from '@valueswap/sdk'
...
import { CloseIcon, CustomLightSpinner, ExternalLink, TYPE, VntwTokenAnimated } from '../../theme'
      ...
      {!attempting && !claimConfirmed && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim VNTW</TYPE.white>
                <CloseIcon onClick={toggleClaimModal} style={{ zIndex: 99 }} color="white" />
              </RowBetween>
              <TYPE.white fontWeight={700} fontSize={36}>
                {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} VNTW
              </TYPE.white>
            </CardSection>
            <Break />
            <CardSection gap="sm">
              {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{SOCKS_AMOUNT} VNTW</TYPE.subHeader>
                </RowBetween>
              )}
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{USER_AMOUNT} VNTW</TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          </ModalUpper>
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <VntwTokenAnimated width="72px" src={tokenLogo} />
            )}
          </ConfirmedIcon>
